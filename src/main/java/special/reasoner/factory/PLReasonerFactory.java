 ...
 */
package special.reasoner.factory;
...
public class PLReasonerFactory implements OWLReasonerFactory {
    ...
    public OWLReasoner createPolicyLogicReasoner(OWLOntology ontology, OWLReasonerConfiguration config, BufferingMode bufferingMode) {
